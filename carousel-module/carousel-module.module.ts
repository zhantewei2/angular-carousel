...
@NgModule({
  ...
  declarations: [ZtwCarouselComponent, CarouselItemComponent, ZtwCarouselImgDirective, ZtwCarouselHeaderDirective],
  exports:[ZtwCarouselComponent,CarouselItemComponent,ZtwCarouselImgDirective,ZtwCarouselHeaderDirective]
})
